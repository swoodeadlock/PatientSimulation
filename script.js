...
I've scheduled you for Thursday at 11:00 AM. Our ASL interpreter service will be fully prepared. Please arrive 15 minutes early.`
  ...
  },
  {
    ...
    type: "multipleSelect",
    narratorText: "It's Wednesday afternoon. You're preparing for Sandra Wilson's appointment with Dr. Martinez scheduled for Thursday at 11:00 AM.",
...
- Dermatology has Proprio until 10:45 AM`,
  ...
  },
  {
    ...
    type: "decision",
    narratorText: "It's Thursday morning. Sandra has arrived 10 minutes early for her appointment. The interpreter device is still pending return.",
    visualElements: {
      type: "scene",
      description: "Reception desk with Sandra waiting; clock shows 10:50 AM; busy clinic background."
    },
    decisionQuestion: "What's the best approach for your initial interaction with Sandra?",
    options: [
      { id: "3a", text: "Make eye contact, smile, and greet her while reaching for a notepad.", feedback: "Good approach. Direct greeting with written communication respects her needs.", isCorrect: true, score: 4, responseContent: { type: "dialog", content: "(You smile and say, 'Good morning! Are you Sandra? Your interpreter will be here shortly.')" } },
      { id: "3b", text: "Make eye contact, smile, and use pre-prepared visual check-in materials.", feedback: "Excellent! Anticipating her needs with a tablet check-in is ideal.", isCorrect: true, score: 5, responseContent: { type: "dialog", content: "(You use a tablet that displays a welcome message and check-in options.)" } },
      { id: "3c", text: "Smile and gesture for her to wait while you call for someone with ASL skills.", feedback: "This approach delays direct communication.", isCorrect: false, score: 1 },
      { id: "3d", text: "Use exaggerated gestures and speak slowly and loudly.", feedback: "Incorrect—this method is condescending and ineffective.", isCorrect: false, score: 0 }
    ],
    followUp: {
      type: "decision",
      narratorText: "Sandra nods and writes, 'Yes, I'm Sandra Wilson. Here for Dr. Martinez at 11:00.'",
      ...
      options: [
        { id: "3e", text: "Have her complete intake forms while you check the interpreter.", feedback: "Too passive; you should ask about communication preferences first.", isCorrect: false, score: 2 },
        { id: "3f", text: "Ask about her communication preferences using a notepad.", feedback: "Excellent—this respects her autonomy.", isCorrect: true, score: 5 }
      ]
    }
  },
  {
    ...
    options: [
      { id: "4a", text: "Restart the device and try connecting again.", feedback: "Restarting is a reasonable first step but may not resolve the issue.", isCorrect: false, score: 2, responseContent: { type: "dialog", content: "(You restart the device, but the error persists.)" }, hasFollowUp: true },
      { id: "4b", text: "Switch to the backup cellular connection.", feedback: "Excellent! This reliably resolves the network issue.", isCorrect: true, score: 5, responseContent: { type: "simulation", steps: [ "Access settings (tap gear icon)", "Select 'Network Configuration'", "Switch from 'Clinic Wi-Fi' to 'Backup Cellular'", "Confirm and test connection", "Adjust video quality to 'Medium'", "Reconnect to interpreter service" ], result: "Connection established. Interpreter available." } },
      { id: "4c", text: "Inform Dr. Martinez to use written communication instead.", feedback: "This abandons the preferred method too quickly.", isCorrect: false, score: 1 },
      { id: "4d", text: "Ask Sandra to use a video relay service on her device.", feedback: "Incorrect—this shifts responsibility to the patient.", isCorrect: false, score: 0 }
    ],
    followUp: {
      type: "decision",
      decisionQuestion: "What will you do now after option 4a?",
      options: [
        { id: "4e", text: "Switch to the backup cellular connection.", feedback: "Good problem-solving!", isCorrect: true, score: 4 },
        { id: "4f", text: "Reduce video quality to minimum.", feedback: "May help but degrades communication quality.", isCorrect: false, score: 2 },
        { id: "4g", text: "Move to a different room for better Wi-Fi.", feedback: "Not guaranteed and causes delays.", isCorrect: false, score: 1 },
        { id: "4h", text: "Proceed with written communication.", feedback: "Abandons preferred method too quickly.", isCorrect: false, score: 0 }
      ]
    },
    finalFollowUp: {
      type: "decision",
      ...
      options: [
        { id: "4i", text: "Bring the device without explanation and let the interpreter handle it.", feedback: "Lacks transparency and may confuse Sandra.", isCorrect: false, score: 1 },
        { id: "4j", text: "Write a brief note: 'Sorry for the delay. Interpreter connected. Dr. Martinez will join shortly.'", feedback: "Provides basic info but misses checking if Sandra is satisfied.", isCorrect: false, score: 2 },
        { id: "4k", text: "Write a note explaining the network issue, confirm connection, and ask if video quality is acceptable.", feedback: "Excellent communication approach.", isCorrect: true, score: 5 },
        { id: "4l", text: "Bring Dr. Martinez to handle the communication.", feedback: "Passes responsibility; explain yourself first.", isCorrect: false, score: 3 }
      ]
    }
  },
  {
    ...
    options: [
      { id: "5a", text: "Introduce yourself to the interpreter and have them greet Sandra.", feedback: "Incorrect. Speak directly to the patient.", isCorrect: false, responseContent: { type: "dialog", content: "You: 'Hello, I'm Dr. Martinez. I'll be conducting your consultation today.'" }, score: 0 },
      { id: "5b", text: "Sit directly across from Sandra, make eye contact, and introduce yourself while the interpreter translates.", feedback: "Good, but a triangular arrangement would be better.", isCorrect: false, responseContent: { type: "dialog", content: "You: 'Hello Sandra, I'm Dr. Martinez. Let's discuss your migraines while the interpreter assists.'" }, score: 3 },
      { id: "5c", text: "Arrange seating in a triangle so Sandra sees both you and the interpreter, then introduce yourself directly.", feedback: "Excellent approach!", isCorrect: true, responseContent: { type: "dialog", content: "You arrange seating in a triangle and say, 'Hello Sandra, I'm Dr. Martinez. I'm here to listen to your concerns. Please let me know if you need adjustments.'" }, score: 5 },
      { id: "5d", text: "Hand her a written questionnaire to complete before speaking.", feedback: "Not ideal for a first consultation.", isCorrect: false, score: 1 }
    ],
    followUp: {
      type: "decision",
      ...
      options: [
        { id: "5e", text: "Ask all questions at once and wait for responses.", feedback: "Inefficient and may cause confusion.", isCorrect: false, score: 1 },
        { id: "5f", text: "Ask one question at a time at a natural pace and wait for the interpreter to finish.", feedback: "Excellent—this respects the communication process.", isCorrect: true, score: 5 },
        { id: "5g", text: "Provide a detailed written history form for Sandra to fill out.", feedback: "Useful as a supplement, not a replacement.", isCorrect: false, score: 2 },
        { id: "5h", text: "Have the interpreter explain the need for history-taking.", feedback: "Incorrect—speak directly to Sandra.", isCorrect: false, score: 0 }
      ]
    },
    finalFollowUp: {
      type: "multipleSelect",
